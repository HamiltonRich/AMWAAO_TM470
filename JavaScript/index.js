document.addEventListener("DOMContentLoaded", function () {
    const users = [
        ...
        {
            upn: "james.parnell@hamiltonsales.com",
            password: "james2024sales!",
            role: "Managing Director",
            region: "North"
        },
        {
            upn: "mauricio.howlett@hamiltonsales.com",
            password: "mauricio2024sales!",
            role: "Managing Director",
            region: "South"
        },
        {
            upn: "elnora.gonzalez@hamiltonsales.com",
            password: "elnora2024sales!",
            role: "Managing Director",
            region: "East"
        },
        { upn: "carl.cash@hamiltonsales.com", password: "carl2024sales!", role: "Managing Director", region: "West" },
        {
            upn: "ann.krug@hamiltonsales.com",
            password: "ann2024sales!",
            role: "Managing Director",
            region: "Southwest"
        },
        {
            upn: "denice.garhart@hamiltonsales.com",
            password: "denise2024sales!",
            role: "Managing Director",
            region: "Northeast"
        },
        {
            upn: "rachel.warren@hamiltonsales.com",
            password: "rachel2024sales!",
            role: "Managing Director",
            region: "Southeast"
        },
        {
            upn: "mary.edwards@hamiltonsales.com",
            password: "mary2024sales!",
            role: "Managing Director",
            region: "Northwest"
        },
        ...
        {
            upn: "patricia.smith@hamiltonsales.com",
            password: "patricia2024sales!",
            role: "Area Manager",
            region: "East"
        },
        {
            upn: "robert.rodriguez@hamiltonsales.com",
            password: "robert2024sales!",
            role: "Area Manager",
            region: "West"
        },
        {
            upn: "lucille.srey@hamiltonsales.com",
            password: "lucille2024sales!",
            role: "Area Manager",
            region: "Southwest"
        },
        {
            upn: "scott.villalobos@hamiltonsales.com",
            password: "scott2024sales!",
            role: "Area Manager",
            region: "Northeast"
        },
        { upn: "gary.boyers@hamiltonsales.com", password: "gary2024sales!", role: "Area Manager", region: "Southeast" },
        {
            upn: "melissa.mills@hamiltonsales.com",
            password: "melissa2024sales!",
            role: "Area Manager",
            region: "Northwest"
        },
